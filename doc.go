...
The authok package handles authentication by exchanging the client id and secret
...
The authok package also handles rate limiting by respecting the `X-Rate-Limit-*`
