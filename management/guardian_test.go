	...
	t.Run("MultiFactor", func(t *testing.T) {
		...
		t.Run("Phone", func(t *testing.T) {
			t.Run("Provider", func(t *testing.T) {
				...
				expectedProvider := &MultiFactorProvider{Provider: authok.String("phone-message-hook")}
		...
		t.Run("SMS", func(t *testing.T) {
			...
			t.Run("Template", func(t *testing.T) {
				...
				expectedTemplate := &MultiFactorSMSTemplate{
					EnrollmentMessage:   authok.String("Test {{code}} for {{tenant.friendly_name}}"),
					VerificationMessage: authok.String("Test {{code}} for {{tenant.friendly_name}}"),
				}
			...
			t.Run("Twilio", func(t *testing.T) {
				...
				expectedTwilio := &MultiFactorProviderTwilio{
					From:      authok.String("123456789"),
					AuthToken: authok.String("test_token"),
					SID:       authok.String("test_sid"),
				}
		...
		t.Run("Push", func(t *testing.T) {
			t.Run("Provider", func(t *testing.T) {
				...
				expectedProvider := &MultiFactorProvider{Provider: authok.String("sns")}
			...
			t.Run("AmazonSNS", func(t *testing.T) {
				...
				expectedSNS := &MultiFactorProviderAmazonSNS{
					AccessKeyID:                authok.String("test"),
					SecretAccessKeyID:          authok.String("test_secret"),
					Region:                     authok.String("us-west-1"),
					APNSPlatformApplicationARN: authok.String("test_arn"),
					GCMPlatformApplicationARN:  authok.String("test_arn"),
				}
			...
			t.Run("CustomApp", func(t *testing.T) {
				...
				expectedCustomApp := &MultiFactorPushCustomApp{
					AppName:       authok.String("bestApp"),
					AppleAppLink:  authok.String("https://itunes.apple.com/us/app/my-app/id123121"),
					GoogleAppLink: authok.String("https://play.google.com/store/apps/details?id=com.my.app"),
				}
			...
			t.Run("DirectAPNS", func(t *testing.T) {
				...
				expectedDirectAPNS := &MultiFactorPushDirectAPNS{
					Sandbox:  authok.Bool(false),
					BundleID: authok.String("com.my.app"),
					P12:      authok.String(string(expectedP12)),
				}
			...
			t.Run("DirectFCM", func(t *testing.T) {
				...
				expectedDirectFCM := &MultiFactorPushDirectFCM{
					ServerKey: authok.String("abc123"),
				}
		...
		t.Run("DUO", func(t *testing.T) {
			...
			t.Run("Settings", func(t *testing.T) {
				...
				updatedSettings := &MultiFactorDUOSettings{
					Hostname:       authok.String("api-hostname"),
					IntegrationKey: authok.String("someKey"),
					SecretKey:      authok.String("someSecret"),
				}
		...
		t.Run("WebAuthn Roaming", func(t *testing.T) {
			...
			t.Run("Settings", func(t *testing.T) {
				...
				updatedSettings := &MultiFactorWebAuthnSettings{
					UserVerification: authok.String("preferred"),
				}
		...
		t.Run("WebAuthn Platform", func(t *testing.T) {
			...
			t.Run("Settings", func(t *testing.T) {
				...
				updatedSettings := &MultiFactorWebAuthnSettings{
					OverrideRelyingParty: authok.Bool(false),
				}
