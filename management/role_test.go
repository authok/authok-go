...
func TestRoleManager_Create(t *testing.T) {
	...
	role := &Role{
		Name:        authok.String("test-role"),
		Description: authok.String("Test Role"),
	}
...
func TestRoleManager_Update(t *testing.T) {
	...
	updatedRole := &Role{
		Description: authok.String("The Administrator"),
	}
...
func givenARole(t *testing.T) *Role {
	...
	role := &Role{
		Name:        authok.String(fmt.Sprintf("test-role%d", rand.Intn(999))),
		Description: authok.String("Test Role"),
	}
